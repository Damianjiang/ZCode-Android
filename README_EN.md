...
- Device pairing: paste the remote-control URL generated by the desktop app; multiple
  devices supported with one-tap switching
...
- [ ] QR code pairing (paste-only for now)
